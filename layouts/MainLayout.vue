<template>
  <div id="mainLayout" class="w-full fixed z-50">
    <div id="topMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      ...
      >
        <li class="list-item">Sell on AliExpress</li>
        <li class="list-item">Help</li>
        <li class="list-item">Buyer Protection</li>
      ...
      >
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            ...
            >
              <input
                class="w-full placeholder-gray-400 text-sm pl-3 focus:outline-none rounded-md"
...
<style>
.list-item {
  @apply border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer;
}
</style>
